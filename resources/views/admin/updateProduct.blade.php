...
@section('page')
    ...
    <form class="row g-3" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="p_title" name="p_title" value="{{$product_data['p_title']}}">
        </div>
        <div class="col-md-4">
            <label for="p_url" class="form-label">Product URL</label>
            <input type="text" class="form-control" id="p_url" name="p_url" readonly value="{{$product_data['p_url']}}">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-12">
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" name="p_premium_note" id="p_premium_note" {{$product_data['p_premium'] == 1?'checked':''}}>
                <label class="form-check-label" for="p_premium_note">Is Product is Premium</label>
            </div>
        </div>
        <div class="col-12 text-center">
            <button type="submit" class="btn btn-primary" name="send_approval">Update</button>
        </div>
    </form>
